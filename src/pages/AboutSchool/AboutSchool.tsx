      ...
      <div className="about-school-content-container">
        ...
        <div className="about-school-text-content">
          ...
          <p>
            ...
            and supportive environment. We strive to provide a high-quality
            education that prepares students for success in their future
            careers.
          </p>
          <p>
          ...
          <p>
            a) To provide excellent educational opportunity for the children, in
            and around Brahmavar, its neighbouring areas and also children from
            all over India.
          </p>
          ...
          <p>
            d) To cater to the needs of the parents who want for their children,
            an education that makes a difference.
          </p>
        </div>
      </div>
      <Carousel
        className="about-school-carousel-container"
        responsive={responsive}
      >
        <img
          src={class1}
          alt="carouser_Image_1"
          className="about-school-carousel-image"
        />
        <img
          src={class2}
          alt="carouser_Image_1"
