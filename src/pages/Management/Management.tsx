...
function Management() {
  return (
    <div id="management-container">
      ...
      <div className="management-details-intro">
        Let us take a moment to appreciate the visionary leadership of our
        founder at Educare for his unwavering dedication to providing quality
